...
When more than three classes are involved, all the dimensions of the ILR space cannot be visualized at once, but $2$ or $3$-dimensional subspaces can still be visualized. In order to select the ILR components to visualize, one needs to understand what they refer to. In this section, we briefly discuss the interpretation of the ILR components in our context.% of the explanation of a classifier prediction with more than three classes.
...
\begin{figure}
  ...
  \caption{Sum of the Shapley compositions from the base to the prediction in the ILR subspace made of $\tilde{p}_3$ and $\tilde{p}_5$.}
