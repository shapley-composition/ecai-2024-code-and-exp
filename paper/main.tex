...
\begin{figure}
  ...
  \caption{Two examples of bifurcation tree. \ref{fig:bifurc1} corresponds to the basis obtained with the Gram-Schmidt procedure as in \cite{egozcue2003isometric} which is the one used in the examples of Figures \ref{fig:3classes} and \ref{fig:4classesshapsum} is another example corresponding to the basis used in the example...}
  \label{fig:trees}
\end{figure}
