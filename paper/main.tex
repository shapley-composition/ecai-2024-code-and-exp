...
The example of Figure \ref{fig:3classes} can be summarized by computing the norms of the Shapley compositions, angles between them and their projection on the set of class-compositions.
