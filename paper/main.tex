...
\item The angle between two Shapley compositions can inform about their orthogonality. If two Shapley compositions are orthogonal%\footnote{We refer here to geometric orthogonality, not to be confused with statistical uncorrelation \cite{pawlowskymodeling}.}
